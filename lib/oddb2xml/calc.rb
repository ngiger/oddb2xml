...
module Oddb2xml
  ...
  class Calc
    ...
    @@galenic_groups = YAML.load_file(File.join(DATA_DIR, "gal_groups.yaml"), permitted_classes: [OpenStruct, Symbol, Struct::GalenicGroup])
    @@galenic_forms = YAML.load_file(File.join(DATA_DIR, "gal_forms.yaml"), permitted_classes: [OpenStruct, Symbol, Struct::GalenicForm])
    @@new_galenic_forms = []
